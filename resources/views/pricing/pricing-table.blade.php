<div class="tab-content" id="plans-tab-content">
    <div class="tab-pane fade show active" id="website-tab-pane" role="tabpanel" aria-labelledby="website-tab" tabindex="0">
        ...
        <div class="position-relative d-none d-md-block">
            <div class="payment-plans">
                <div class="payment-plans-head mb-3">
                    <div class="payment-plans-row">
                        <div class="payment-plans-row">
                            <div class="payment-plans-cell"></div>
                            <div class="payment-plans-cell">
                                <h5 class="title ">Beginner</h5>
                                <h2 class="title">$10,000</h2>
                            </div>
                            <div class="payment-plans-cell">
                                <h5 class="title ">Skilled</h5>
                                <h2 class="title">$25,000</h2>
                            </div>
                            <div class="payment-plans-cell">
                                <h5 class="title">Specialist</h5>
                                <h2 class="title">$50,000</h2>
                            </div>
                            <div class="payment-plans-cell">
                                <h5 class="title ">Champion</h5>
                                <h2 class="title">$100,000</h2>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="payment-plans-body">
                    ...
                    <div class="payment-plans-row__container">
                        <div class="payment-plans-row">
                            ...
                            <div class="payment-plans-cell">
                                <div class="challange-data" data-challange="1">
                                    <span>1000$ (10%)</span>
                                </div>
                                <div class="challange-data" data-challange="2">
                    ...
                    <div class="payment-plans-row__container footer-row">
                        <div class="payment-plans-row">
                            <div class="payment-plans-cell">
        ...
        <div class="position-relative d-block d-md-none">
            <div class="payment-plans">
                <div class="payment-plans-head mb-3">
                    <div class="payment-plans-row planSlider">
                        <div class="payment-plans-cell"></div>
                ...
                <div class="payment-plans-body">
                    ...
                    <div class="payment-plans-row__container">
                        <div class="payment-plans-row">
                            ...
                            <div class="payment-plans-cell">
                                <div class="leverage-data" data-leverage="1:5">
                                    <span>1000$ (10%)</span>
                                </div>
                                <div class="leverage-data" data-leverage="1:10">
                                    <span>1500$ (15%)</span>
                                </div>
                                <div class="leverage-data" data-leverage="1:20">
                                    <span>1500$ (15%)</span>
                                </div>
                            </div>
                            <div class="payment-plans-cell">
